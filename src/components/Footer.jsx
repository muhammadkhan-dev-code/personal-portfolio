    ...
    <>
      <footer className="bg-[#0F172A] py-12 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-4 text-center">
          <h3 className="text-white font-extrabold text-xl">Muhammad Khan</h3>
          <a
          ...
          <p className="text-gray-500 text-xs mt-4">
            © Built by Muhammad Khan. All rights reserved.
          </p>
        </div>
      </footer>
      ...
      {showScroll && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-6 right-6 z-50 w-11 h-11 rounded-full bg-white text-[#4338CA] shadow-lg flex items-center justify-center hover:bg-[#EEF2FF] transition-all duration-200"
